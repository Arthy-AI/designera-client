...
export const SubscriptionCards = ({children, selected, onSelect, ...props}: SubscriptionCards) => {
    return (
        <div className={"h-fit grid grid-cols-1 sm:grid-cols-3 gap-6"}>
            <div
                className={"h-fit bg-[#2f2f2f] text-white border-4 designera-rounded p-2 md:p-10 flex flex-col items-center gap-2 md:gap-5 cursor-pointer"}
            ...
            >
                ...
                <div className={"SubscriptionThumbnailContainer w-fit relative my-10 flex justify-center"}>
                    <div className={"block w-36 h-24 md:w-52 md:h-40 bg-[#414141] z-20 rounded-3xl p-4"}>
                        <img
                            src="https://media.discordapp.net/attachments/551764588136497152/1060558899612221542/Interior-vector_1.png"/>
                    </div>
                    <div className={"top-0 absolute w-36 h-24 md:w-52 md:h-40 bg-[#69343F] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "-15deg"}}>
                    </div>
                </div>
                <div className={"Description Font-Light text-center text-xs text-stone-200 mb-3 md:px-2"}>
                ...
                <div className={"SubscriptionThumbnailContainer relative my-5 flex justify-center"}>
                    <div
                        className={"relative w-32 h-24 md:w-40 md:h-32 bg-[#111111] z-20 rounded-3xl flex flex-col gap-1 justify-center items-center"}>
                    ...
                    <div className={"top-0 absolute w-32 h-24 md:w-40 md:h-32 bg-[#69343F] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "15deg"}}>
                    </div>
                </div>
            </div>
            ...
            <div
                className={"h-fit bg-[#2f2f2f] text-white border-4 designera-rounded p-2 md:p-10 flex flex-col items-center gap-2 md:gap-5 cursor-pointer relative"}
                ...
                <div className={"SubscriptionThumbnailContainer w-fit relative my-10 flex justify-center"}>
                    <div
                        className={"relative w-36 h-24 md:w-52 md:h-40 bg-[#414141] z-20 rounded-3xl flex justify-center items-center"}>
                        <img
                            src="https://media.discordapp.net/attachments/551764588136497152/1060558899033411665/Interior-vector_2.png"/>
                    </div>
                    <div className={"top-0 absolute w-36 h-24 md:w-52 md:h-40 bg-[#7A673D] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "-15deg"}}>
                    </div>
                </div>
                <div className={"Description Font-Light text-center text-xs text-stone-200 mb-3 "}>
                    As you subscribe to <span className="Font-Medium text-orange-400">Designera</span>,
                    You
                    will access all
                    of it’s features without <span className={"Font-Regular"}>limitations or additional fees</span>
                ...
                <div className={"SubscriptionThumbnailContainer relative my-5 flex justify-center"}>
                    ...
                    <div className={"top-0 absolute w-32 h-24 md:w-40 md:h-32 bg-[#7A673D] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "15deg"}}>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div className={"SubscriptionThumbnailContainer w-fit relative my-10 flex justify-center"}>
                    ...
                    <div className={"top-0 absolute w-36 h-24 md:w-52 md:h-40 bg-[#767B52] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "-15deg"}}>
                    </div>
                </div>
                <div className={"Description Font-Light text-center text-xs text-stone-200 mb-3"}>
                ...
                <div className={"SubscriptionThumbnailContainer relative my-5 flex justify-center"}>
                    ...
                    <div className={"top-0 absolute w-32 h-24 md:w-40 md:h-32 bg-[#767B52] z-10 rounded-3xl"}
                         style={{zIndex: 2, rotate: "15deg"}}>
                    </div>
                </div>
            </div>
