                    ...
                    <div className={"w-2/3 min-h-screen p-5"}>
                        {isSearching && (
                            <div
                                ...
                                {[...Array(16)].map((v, i) => (
                                    <div key={i} className={`w-full h-full odd:bg-neutral-700 bg-neutral-700 rounded-xl`}></div>
                                ))}
                            </div>
                        )}
                        {results.length &&
                            <Gallery
                                photos={results.length ? results : null} direction={"column"} margin={12} columns={5}
